...
test_that("relation_h_d() avec param déterministe et fichier des parametres fournis estime les bonnes hauteurs", {
  data_arbre <- readRDS(test_path("fixtures", "data_arbre.rds"))
  data_arbre_attendu <- readRDS(test_path("fixtures", "data_arbre_attendu.rds"))
...
test_that("relation_h_d() avec mode_simiul=STO mais grouping_vars non null retourne un message d'erreur", {
  data_arbre <- data.frame(id_pe=1, veg_pot='FE3', sdom_bio="1", milieu=0, p_tot=1000, t_ma=0.1, altitude=200, essence='ERS', dhpcm=10, nb_tige=10, no_arbre=1, step=1)
  parametre_ht <- param_ht(fic_arbres=data_arbre, mode_simul='STO', nb_iter=1, nb_step=1)
  DataHt <- relation_h_d(fic_arbres=data_arbre, grouping_vars = 'step', mode_simul='STO', parametre_ht = parametre_ht)
  expect_equal(DataHt, "grouping_vars can not be used with mode_simul=STO")
})
...
test_that("relation_h_d() avec veg_pot non traitée retourne une hauteur NaN", {
...
test_that("relation_h_d() avec milieu manquant retourne une hauteur NaN", {
...
test_that("relation_h_d() avec sdom_bio non traité retourne une hauteur NaN", {
...
test_that("relation_h_d() avec p_tot manquant retourne une hauteur NaN", {
...
test_that("relation_h_d() avec t_ma manquant retourne une hauteur NaN", {
...
test_that("relation_h_d() avec altitude manquant retourne une hauteur NaN", {
...
test_that("relation_h_d() avec nb_tige manquant retourne une hauteur NaN", {
...
test_that("relation_h_d() avec un seul arbre et nb_tige=0 retourne une hauteur NaN", {
...
test_that("relation_h_d() avec milieu catégorique retourne une erreur", {
  ...
  expect_error(relation_h_d(fic_arbres=data_arbre))
})
